import { _decorator, Component, Node, Vec2, EventTouch, CCInteger, UIOpacity, EventHandler, UITransform, Vec3, cclegacy } from 'cc';
...
export class JoyStickController extends Component {
    ...
    private froggie: FrogieController;
    ...
    private onBegin(screenPosition: Vec2) : void {
		...
		position = this.node.inverseTransformPoint(position, new Vec3(screenPosition.x, screenPosition.y, 0));
